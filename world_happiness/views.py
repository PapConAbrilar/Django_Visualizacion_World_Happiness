...
class CustomLoginView(LoginView):
    ...
    def form_valid(self, form):
        ...
        messages.success(self.request, f'¡Bienvenido, {form.get_user().username}! Has iniciado sesión correctamente.')
        return super().form_valid(form)
    
    def form_invalid(self, form):
        """Handle failed login"""
        messages.error(self.request, 'Error al iniciar sesión. Por favor, verifica tu usuario y contraseña.')
...
class CustomLogoutView(LogoutView):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        # Call parent dispatch to perform logout
